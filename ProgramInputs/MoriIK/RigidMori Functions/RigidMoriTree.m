classdef RigidMoriTree < robotics.manip.internal.InternalAccess
...
%#codegen
    ...
    methods
        function obj = RigidMoriTree(varargin)
        ...
        %       rightwrist = getBody(baxter, 'right_wrist')
            ...
            bodyhandle = RigidMori('-', 'BodyInternal', bodyInternal, ... %NOTE !!!MODIFIED!!!
        ...
        %   addSubtree
            ...
            narginchk(3,3);
            validateattributes(bodyin, {'RigidMori'}, ...
        ...
        %   See also replaceJoint
            narginchk(3,3);
            validateattributes(newbody, {'RigidMori'}, ...
        ...
        %   See also subtree, addSubtree, addBody
            ...
            newrobot = RigidMoriTree('MaxNumBodies', newRobotInternal.MaxNumBodies, 'DataFormat', newRobotInternal.DataFormat);
        ...
        %       puma1_cpy = COPY(puma1)
            ...
            newrobot = RigidMoriTree('MaxNumBodies', obj.MaxNumBodies, 'DataFormat', obj.DataFormat);
            newrobot.TreeInternal = newRobotInternal;
        end
        ...
        %   See also subtree, removeBody
            ...
            validateattributes(subtreerobot, {'RigidMoriTree'},...
    ...
    methods
        ...
        %get.Bodies
            ...
            for i = coder.unroll(1:obj.TreeInternal.MaxNumBodies)
                if i <= obj.NumBodies
                    bodies{j} = RigidMori('-', 'BodyInternal', obj.TreeInternal.Bodies{i}, ... %NOTE !!!Modified!!!
                                          'TreeInternal', obj.TreeInternal);
                    j = j + 1;
                end
            end
        ...
        %get.Base
            base = rigidBody('-', 'BodyInternal', obj.TreeInternal.Base, ... %TODO consider changin to RigidMori?
                             'TreeInternal', obj.TreeInternal);
        end
    ...
    methods (Static, Access = ?robotics.manip.internal.InternalAccess)
        ...
        %fromTreeInternal Create object from object of internal class
            obj = RigidMoriTree('MaxNumBodies', ...
